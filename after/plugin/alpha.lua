...
local function personal_config()
  ...
  local holo_quotes = {
    ...
    { "Have confidence!", "Inugami Korone" },
    { "Ahh the pepeloni - you know the pepeloni?", "Haachama" },
    { "All over the glass, all over the glass.", "Gawr Gura" },
    { "A", "Gawr Gura" },
    { "Fuck you chat!", "Mori Calliope" },
    { "It was the PING!!", "Amelia Watson" },
    { "F**king B*tch!", "Amelia Watson" },
    { "Poi ~", "Shishiro Botan" },
    { "Get ReKT", "Ceres Fauna" },
    { "UUUuuuuuuuuuu ~", "Ceres Fauna" },
  }
